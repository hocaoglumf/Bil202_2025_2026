...
Bu örnek multiple inheritance’ın güzel bir kullanımını gösterir:

Device → temel cihaz bilgisi

NetworkEnabled → ağ özelliği

BatteryPowered → batarya özelliği

SmartPhone bunların hepsini birleştirir.
